  ...
  return (
    <section className="relative bg-[var(--bone)] py-32 text-[var(--ink)]">
      <div className="mx-auto max-w-[1500px] px-6 md:px-12">
        <p className="mb-16 font-mono text-xs uppercase tracking-[0.3em] text-[var(--ink)]/50">
          07 / Manifesto
        </p>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          >
            <h2 className="font-serif text-5xl italic leading-[1.05] md:text-8xl">
              ...
              brochures.
              <br />
              <span className="font-display not-italic">We make</span>
              <br />
          ...
          <div className="col-span-12 my-16 grid grid-cols-12 gap-6">
            <img
              ...
              width={1280}
              height={1600}
              className="col-span-12 aspect-[4/5] rounded-2xl object-cover md:col-span-4"
            />
            <div className="col-span-12 space-y-6 self-center md:col-span-5">
              <p className="font-serif text-2xl italic md:text-3xl">
                The good stuff lives in the friction between disciplines — strategy that designs,
                design that ships, code that sells.
              </p>
              <p className="text-sm text-[var(--ink)]/60">
                — Founders' note, kriyas Quarterly Vol. 04
              </p>
            </div>
            <img
              src={b1}
              ...
              width={1600}
              height={1280}
              className="col-span-12 mt-12 aspect-[16/10] rounded-2xl object-cover md:col-span-12"
            />
          </div>
        </div>
      </div>
